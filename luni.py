...
Y = '\x1b[1;93m'
P = '\x1b[1;95m'
os.system('xdg-open https://www.facebook.com/profile.php?id=AHSAN RJTalpur786')
logo=(f"""{Y}
 88888 88   88 88b 88  dP""b8 88     88     
    88 88   88 88Yb88 dP   `" 88     88     
o.  88 Y8   8P 88 Y88 Yb  "88 88  .o 88     
"bodP' `YbodP' 88  Y8  YboodP 88ood8 88     
""")
...
def method():
    ...
    if lp.isnumeric():
        pp=[]
        clear()
        ex = 'FIRSTLAST FIRST LAST FIRSTKHAN'
        print(f'{oo("+")}{ex} (XXX)')
        lin3()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r {R}[{W}JUNGLI{R}] {P}({Y}{loop}{W} / {W}{len(idx)}{P}) {W}• {G}{len(oku)}\r')
        sys.stdout.flush()
        loop+=1
        for pswd in pp:
              heads=None
              ...
              if 6==random.randint(1,300):
                 oku.append(acc)
                 print('\033[1;32m[JUNGLI-OK~👍] \033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)
                 open('/sdcard/JOB-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              else:
                   continue   
